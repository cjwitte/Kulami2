...
public class CommTest {
	...
	//	Game game2 = new Game(2021, "localhost", 1, board, new KIPlayer("Richard", 1, board));
		...
		SwingUtilities.invokeLater(new Runnable() {
				public void run() {
					GameFrame gameFrame1 = new GameFrame(new Game(2021, "localhost", 1, board, new Player("Jon", board)));
					gameFrame1.init();
				}	
		});
		...
		SwingUtilities.invokeLater(new Runnable() {
			public void run() {
				GameFrame gameFrame2 = new GameFrame(new Game(2021, "localhost", 1, board, new KIPlayer("Richard", 1, board)));
				gameFrame2.init();
			}	
		});				
