...
public class CommTest {
	...
	public static void main(String[] args) {
		...
		Game game = new Game (12345, "localhost", 1, board, new Player(args[0], board));
...
//		Game game = new Game (12345, "localhost", 1, board, new Player("Jon", board));
//		Game game2 = new Game(12345, "localhost", 1, board, new KIPlayer("Rick", 1, board));
